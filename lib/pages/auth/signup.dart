        ...
        Container(
          ...
          child: RaisedButton(
            ...
            onPressed: () {
              ...
              } else if (studId.isEmpty || studId.length < 8 || studId.contains(RegExp('R[A-Z]'))) {
                displayToastMessage("Student ID  is mandatory and must not be less than 8 and must be a number", context);
